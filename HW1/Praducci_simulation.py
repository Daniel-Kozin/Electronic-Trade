...
import numpy as np
import os
from select_influencers import find_nodes_by_score_and_cost, hill
...
ROUNDS = 6
P_BASE = 0.2
EXAMPLE_INFLUENCERS_FILENAME = 'selected_users.csv'
...
if __name__ == '__main__':
	...
	if graph is None or haters is None or costs is None:
		...
		if not os.path.exists(EXAMPLE_INFLUENCERS_FILENAME):
			...
			#example_influencers = hill(graph, haters, costs)
			example_influencers = read_influencers_from_csv(EXAMPLE_INFLUENCERS_FILENAME, costs, haters)

			# - 2071
			#example_influencers = [1857, 4035, 233, 2378, 400, 499, 3801, 3674, 1789, 3423]
			# run ^ for iter = 3 to get 2188
			#2176
			#example_influencers = [1857, 4035, 233, 2378, 553, 400, 499, 3926, 2263, 3544, 3801, 3674, 1789, 3423]
		...
		for x in range(iterations):
			if example_influencers is not None:
				...
				STUDENT_ID_1 = '215550260' # Example ID (string)
				STUDENT_ID_2 = '326391885' # Example ID (string)
		...
		print(f"The expected value is E = {total / iterations}")
